...
function(params){
    ...
    that.collapse = function(isImmediately){
        ...
        cm.replaceClass(that.params['target'], 'is-app-sidebar--expanded', 'is-app-sidebar--collapsed', true);
    ...
    that.expand = function(isImmediately){
        ...
        cm.replaceClass(that.params['target'], 'is-app-sidebar--collapsed', 'is-app-sidebar--expanded', true);
        // Remove immediately animation hack
        if(isImmediately){
            setTimeout(function(){
                cm.removeClass(that.nodes['container'], 'is-immediately');
